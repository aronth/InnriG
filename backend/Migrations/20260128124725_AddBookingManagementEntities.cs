...
{
    /// <inheritdoc />
    public partial class AddBookingManagementEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForWho = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedsPrint = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Restaurants_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingMenuItems", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BookingMenuItems_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingMenuItems_BookingId",
                table: "BookingMenuItems",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingMenuItems_MenuItemId",
                table: "BookingMenuItems",
                column: "MenuItemId");
