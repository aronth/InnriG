    ...
    <div class="px-4">
      <div class="flex justify-between h-16">
        <div class="flex items-center gap-8">
          ...
          <div class="hidden sm:flex sm:space-x-1">
            ...
            <NuxtLink 
              ...
              to="/menus" 
              class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md transition-colors duration-200"
              :class="[$route.path.startsWith('/menus') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900']"
            >
              Matseðlar
            </NuxtLink>
        ...
        <div class="flex items-center gap-4">
          <!-- System Settings Button (Admin/Manager only) -->
          <NuxtLink
            v-if="currentUser && canAccessAdmin"
            to="/settings/system"
            class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200"
            :class="[$route.path.startsWith('/settings/system') || $route.path.startsWith('/settings/users') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900']"
